...
def process_users_command(choice, running, *, # TODO - Set the keyword arguments such that;
    show_goodbye=True,# 1. show_goodbye defaults to True
    goodbye_message='Thank you for using python CLI file Manager!'# 2. goodbye_message defaults to "Thank you for using Python CLI File Manager!"
    invalid_choice_prefix='invalid choice:',# 3. invalid_choice_prefix defaults to "Invalid choice:"
valid_command='help, calc, info, quit'# 4. valid_commands defaults to "help, calc, info, quit'
):
   ...
   display_welcome() # TODO: Call the function to display the welcome message
    ...
    while running:
        try:
            ...
            running = process-user_command(choice, running)
